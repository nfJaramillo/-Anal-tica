    ...
    return new Scaffold(
      body: new SingleChildScrollView(
          ...
          child: new Form(
              ...
              new FormularioUITexto('Escribe nombre y apellido', "Nombre de 1 de las" +'\n'+ "personas visitadas", _entrevista, Icon(Icons.person_outline), 2),
              ...
              new  FormularioUIEleccionMultiple(_siOnoOpciones, '¿Posee servicio de ' +'\n'+ ' energía eléctrica?', _entrevista, Icon(Icons.power), 7),

              new FormularioUIEleccionMultiple(_siOnoOpciones, '¿Posee servicio de ' +'\n'+ 'Gas Natural?', _entrevista, Icon(Icons.restaurant), 8),

              new FormularioUIEleccionMultiple(_siOnoOpciones, '¿Posee servicio de ' +'\n'+ ' acueducto, Alcantarillado' +'\n'+ 'y Recolección de Basuras?', _entrevista, Icon(Icons.local_drink), 9),
                   
              new FormularioUIEleccionMultiple(_siOnoOpciones, '¿Posee servicio de Telefonía ' +'\n'+ ' e Internet (fija o móvil) ?', _entrevista, Icon(Icons.wifi), 10),

              new FormularioUITexto('Si no, escriba No', '¿Alguno tiene una ' +'\n'+ ' enfermedad grave? ', _entrevista, Icon(Icons.local_hospital), 11),
              ...
              new FormularioUIEleccionMultiple(_medios, '¿Medio de información ' +'\n'+ 'que utilizan mas?', _entrevista, Icon(Icons.book), 14),

              new FormularioUIEleccionMultiple(_siOnoOpciones, '¿Hay organizaciones de ' +'\n'+ ' la sociedad civil? ', _entrevista, Icon(Icons.group), 15),
